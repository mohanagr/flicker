...
for ii in range(niter):
    ...
    I=re.ybig
    Q=im.ybig
    gn.upconvert_delay_noise(ybig,I,Q,t_orig,carrier,0.01) #last argument is sigma of noise you wanna add
    I=gn.cubic_spline(t_new, t_orig, re.ybig)
    Q=gn.cubic_spline(t_new, t_orig, im.ybig)
    gn.upconvert_delay_noise(ybig2,I,Q,t_new,carrier,0.01)
    obj1.pfb(ybig)
    obj2.pfb(ybig2)
    #save data
